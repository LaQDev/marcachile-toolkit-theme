...
$title = str_replace("[palabra]",$palabra,get_the_title());

/* Template Name: Toolkit - Busqueda */
                    ...
                    <div class="row">
                                ...
                                <div class="toolkit-search">
                                    ...
                                    <div class="toolkit-search__row">
                                        ...
                                        <input id="palabra" name="palabra" type="search" class="toolkit-search__input"
                                            placeholder="Buscar por palabra clave (ej: 'Cobre', 'Patagonia', 'Logo')..." value="<?php echo $palabra;?>">
                        ...
                        if ($query->have_posts()){
                            ...
                            <div class="row row-cols-1 row-cols-md-12 g-4">
                                <center>
                                    <img src="/toolkit/wp-content/themes/Toolkit-Claude/images/not-found.svg">
                                    <br>
