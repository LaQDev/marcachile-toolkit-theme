        ...
        <div class="row gx-6 mx-0">
            ...
            <div class="col-md-9 marca-chile-col-toolkit pt-md-0 px-md-0 mb-4">
                ...
                <div class="marca-chile-toolkit-wrap">
                        ...
                        <div class="col-md-12">
                            <div class="marca-chile-filter">
                                <div class="marca-chile-filter-title">
                                    <picture>
                                        <img
                                            src="<?php bloginfo('template_url'); ?>/images/ico/toolkit/ico-toolkit-filter-01.svg">
                                    </picture>
                                    <p><?php the_title(); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="row gx-6">
                        <div class="col-md-12">
                            <div class="marca-chile-card-toolkit-manual">
                                <div class="marca-chile-card-toolkit-manual-info">
                                    <?php if (get_field("insumopagina")) { ?>
                                        <h1><?php echo the_field("insumopagina"); ?></h1>
                                    <?php } ?>


                                    <picture>
                                        <img src="<?php the_field("insumo_preview"); ?>" alt="">
                                    </picture>
                                    <h5>Descripción</h5>
                                    <p><?php the_field("descripcion_insumo"); ?></p>
                                </div>
                                <div class="manual-link-descarga">
                                    <picture class="manual-ico">
                                        <img src="<?php bloginfo('template_url'); ?>/images/ico/toolkit/ico-toolkit-download.svg"
                                            alt="">
                                    </picture>
                                    <a href="<?php the_field("descargapagina"); ?>">Descarga .Zip</a>
                                </div>
                            </div>
                        </div>
                    </div>
