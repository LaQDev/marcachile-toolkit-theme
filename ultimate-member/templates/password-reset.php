				...
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/2025/icon-correo.png">
							<br>
							Te hemos enviado un correo electrónico. Por favor, revísalo y sigue las instrucciones.
						</div>
					</div>
				</div>
